                                    ...
                                    <?php $i=1; foreach ($gwork as $key => $value) {?>
                                        <li>
                                            <label>
                                                ...
                                                <a id="iconType<?php echo ($i++>9)?$i:"0".$i;?>" href="/hokuriku/job_<?php echo $value['name'];?>"><?php echo $value['name'];?></a>
                                            </label>
                                            <span>└ 営業、事務、受付...</span>
                                        </li>
                                    <?php }?>
                                       ...
                                       <?php 
                                        if(isset($feature_name) && !empty($feature_name)){
                                         ...
                                         ?>
                                               ...
                                               <li>
                                                    <a href="/hokuriku/feature/<?php echo $value['feature_name'];?>"><?php echo $value['feature_name'];?></a>
                ...
                <div id="pickupBox">
                    ...
                    <div class="pickup01">
                        ...
                        <div class="pickuplist">
                            ...
                            <?php foreach ($feature_name as $key => $value) { ?>
                           <li>
                                <a href="<?php echo base_url();?>hokuriku/feature/<?php echo $value['feature_name'];?>"><?php echo $value['feature_name'];?></a>
                                (<?php echo $count_work_feature[$value['feature_name']];?>)                             
                            </li>                                                  
                                <?php }?>
                            <?php 
                    ...
                    <div class="pickup02">
                        ...
                        <div class="pickuplist">
                            ...
                            ?>
                                ...
                                <li>
                                    <a href="hokuriku/special/<?php echo $value['name'];?>"><?php echo $value['name'];?></a>
                    ...
                    <div class="pickup03">
                        ...
                        <div class="pickuplist">
                            ...
                            <?php foreach ($ninki_area as $key => $value) { ?>
                                <li>
                                    <a href="hokuriku/station/<?php echo $value['id'];?>"><?php echo $value['name'];?></a>
                    ...
                    <div class="pickup04">
                        ...
                        <ul>
                            ...
                            ?>
                            <li>
                                <a href="<?php echo base_url();?>hokuriku/feature/<?php echo $shop_name[0]['feature_name'];?>"><?php echo $shop_name[0]['feature_name']?></a>
                                (<?php echo $count_work_shop[$shop_name[0]['feature_name']];?>)                             
                            </li>
                            <li>
                                <a href="<?php echo base_url();?>hokuriku/feature/<?php echo $shop_name[6]['feature_name'];?>"><?php echo $shop_name[6]['feature_name']?></a>
                                (<?php echo $count_work_shop[$shop_name[6]['feature_name']];?>)                             
                            </li>
                            <li>
                                <a href="<?php echo base_url();?>hokuriku/feature/<?php echo $feature_name[9]['feature_name'];?>"><?php echo $feature_name[9]['feature_name']?></a>
