 ...
 <head>
	...
	<div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
		<div id="sidebar"><div id="sidebar-wrapper"> <!-- Sidebar with logo and menu -->
			...
			<a href='/member'><img id="logo" src="template/backend/simpla-admin/resources/images/logo.png" alt="Simpla Admin logo" /></a>
			<div id="profile-links">
				Hello, <a href="<?php echo base_url();?>member/profile" title="Edit your profile"><?php echo (isset($user))? htmlspecialchars($user['username']) : 'Member';?></a>, you have <a href="#messages" rel="modal" title="3 Messages">3 Messages</a><br />
				<br />
				<a href="#" title="View the Site">View the Site</a> | <a href="<?php echo base_url();?>user/logout" title="Sign Out">Sign Out</a>
			</div>        
			<ul id="main-nav">  <!-- Accordion Menu -->
				<li>
					...
					<li> 
						...
						<ul>
							<li><a <?php echo (isset($active) && $active=='member-add')? 'class="current"' : '' ?> href="<?php echo base_url();?>member/add">Write a new Article</a></li>
							<li><a <?php echo (isset($active) && $active=='member-view')? 'class="current"' : '' ?> href="<?php echo base_url();?>member/view">Manage Articles</a></li> <!-- Add class "current" to sub menu items also -->
					...
					<li>
						...
						<ul>
							<li><a href="member/add">Write a page</a></li>
							<li><a href="member/view">Manage Pages</a></li>
						</ul> -->
					</li>
				...
				<li>
					...
					<ul>
						...
						<li><a href="<?php echo base_url();?>member/profile">Your Profile</a></li>
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<ul class="shortcut-buttons-set">
				...
				<li><a class="shortcut-button" href="/member/add"><span>
