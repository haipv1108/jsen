            ...
            <div id="midArea" class="clearfix">
                ...
                <div class="menuArea clearfix">
                    ...
                    <div class="naviArea">
                        <ul class="clearfix">
                            <li id="naviKanto">
                                <a title="東京、神奈川、埼玉、千葉、茨城、栃木、群馬" href="<?php echo base_url();?>user/kanto">関東</a>
                            </li>
                            <li id="naviTokai">
                                <a title="愛知、岐阜、静岡、三重" href="<?php echo base_url();?>user/tokai">東海</a>
                            </li>
                            <li id="naviKansai">
                                <a title="大阪、兵庫、京都、滋賀、奈良、和歌山" href="<?php echo base_url();?>user/kansai">関西</a>
                            </li>
                            <li id="naviTohoku">
                                <a title="北海道、青森、岩手、宮城、秋田、山形、福島" href="<?php echo base_url();?>user/tohoku">北海道・東北</a>
                            </li>
                            <li id="naviHokuriku">
                                <a title="山梨、新潟、長野、富山、石川、福井" href="<?php echo base_url();?>user/hokuriku">甲信越・北陸</a>
                            </li>
                            <li id="naviChugoku">
