        ...
        <div id="mainContents">
            <div id="article">
                    ...
                    <div id="mainPanel" class="clearfix">
                        <div id="selectMenu">
                            <div id="chooseBox">
                                ...
                                <ul class="idTabs">
                                    ...
                                    <li class="cb02">
                                        <a class="selected" href="#lineMapBox">路線から探す</a>
                                    </li>
                                    <li class="cb03">
                            ...
                            <div id="freewordBox">
                                <div class="fwArea">
                                    <form method="get" action="https://j-sen.jp/search/">
                                        <input type="hidden" value="tokai" name="area">
                        ...
                        <div id="areaMapBox" class="clearfix" style="display: none;">
                            ...
                            <div class="aMap">
                                <ul class="idTabs">
                                    <li class="am21">
                                        <a href="/guide_area21.htm">愛知</a>
                                    </li>
                                    <li class="am22">
                                        <a href="/guide_area22.htm">岐阜</a>
                                    </li>
                                    <li class="am23">
                                        <a href="/guide_area23.htm">静岡</a>
                                    </li>
                                    <li class="am24">
                                        <a href="/guide_area24.htm">三重</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div id="lineMapBox" class="clearfix" style="display: none;">
                            ...
                            <div class="aMap">
                                <ul>
                                    <li class="am21">
                                        <a href="/guide_area21_line.htm">愛知</a>
                                    </li>
                                    <li class="am22">
                                        <a href="/guide_area22_line.htm">岐阜</a>
                                    </li>
                                    <li class="am23">
                                        <a href="/guide_area23_line.htm">静岡</a>
                                    </li>
                                    <li class="am24">
                                        <a href="/guide_area24_line.htm">三重</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                    ...
                                    <ul>
                                        <li>
                                            <label>
                                                ...
                                                <a id="iconType01" href="/tokai/job_office.htm">オフィス系</a>
                                            </label>
                                            <span>└ 営業、事務、受付...</span>
                                        </li>
                                        <li>
                                            <label>
                                                ...
                                                <a id="iconType02" href="/tokai/job_digital.htm">デジタル・クリエイティブ系</a>
                                            </label>
                                        ...
                                        <li>
                                            <label>
                                                ...
                                                <a id="iconType03" href="/tokai/job_enter.htm">エンターテインメント系</a>
                                            </label>
                                        ...
                                        <label>
                                            <input type="checkbox" value="mass" name="job[]">
                                                <a id="iconType04" href="/tokai/job_mass.htm">マスコミ系</a>
                                            </label>
                                        ...
                                        <li>
                                            <label>
                                                ...
                                                <a id="iconType05" href="/tokai/job_food.htm">フード系</a>
                                            </label>
                                        ...
                                        <li>
                                            <label>
                                                ...
                                                <a id="iconType06" href="/tokai/job_sales.htm">販売・ファッション系</a>
                                            </label>
                                        ...
                                        <li>
                                            <label>
                                                ...
                                                <a id="iconType07" href="/tokai/job_institution.htm">施設・サービス系</a>
                                            </label>
                                        ...
                                        <li>
                                            <label>
                                                ...
                                                <a id="iconType08" href="/tokai/job_transport.htm">配送・物流系</a>
                                            </label>
                                        ...
                                        <li>
                                            <label>
                                                ...
                                                <a id="iconType09" href="/tokai/job_create.htm">軽作業・製造系</a>
                                            </label>
                                        ...
                                        <li>
                                            <label>
                                                ...
                                                <a id="iconType10" href="/tokai/job_medical.htm">医療・福祉系</a>
                                            </label>
                                        ...
                                        <li>
                                            <label>
                                                ...
                                                <a id="iconType11" href="/tokai/job_teacher.htm">塾講師・インストラクター系</a>
                                            </label>
                                        ...
                                        <li>
                                            <label>
                                                ...
                                                <a id="iconType12" href="/tokai/job_beauty.htm">ビューティー系</a>
                                            </label>
                                    ...
                                    <ul>
                                        <li>
                                            <label>
                                                ...
                                                <a id="iconType13" href="/tokai/feature_short_work.htm">短期OK</a>
                                                (1913)
                                            </label>
                                        </li>
                                        <li>
                                            <label>
                                                ...
                                                <a id="iconType25" href="/tokai/feature_week_saraly.htm">週払いOK</a>
                                                (5744)
                                            </label>
                                        </li>
                                        <li>
                                            <label>
                                                ...
                                                <a id="iconType14" href="/tokai/feature_day_saraly.htm">日払いOK</a>
                                                (1804)
                                            </label>
                                        </li>
                                        <li>
                                            <label>
                                                ...
                                                <a id="iconType26" href="/tokai/feature_choose_shift.htm">曜日や時間が選べる</a>
                                                (15752)
                                            </label>
                                        </li>
                                        <li>
                                            ...
                                            <a id="iconType15" href="/tokai/feature_school.htm">高校生OK</a>
                                            (2930)
                                            </label>
                                        </li>
                                        <li>
                                            <label>
                                                ...
                                                <a id="iconType27" href="/tokai/feature_day_shift.htm">週1日からOK</a>
                                                (3457)
                                            </label>
                                        </li>
                                        <li>
                                            <label>
                                                ...
                                                <a id="iconType16" href="/tokai/feature_touroku.htm">登録制</a>
                                                (7917)
                                            </label>
                                        </li>
                                        <li>
                                            <label>
                                                ...
                                                <a id="iconType28" href="/tokai/feature_use_language.htm">語学力を生かせる</a>
                                                (10356)
                                            </label>
                                        </li>
                                        <li>
                                            <label>
                                                ...
                                                <a id="iconType17" href="/tokai/feature_color_pierced.htm">茶髪・ピアスOK</a>
                                                (6615)
                                            </label>
                                        </li>
                                        <li>
                                            <label>
                                                ...
                                                <a id="iconType29" href="/tokai/feature_no_age.htm">年齢不問</a>
                                                (4968)
                                            </label>
                                        </li>
                                        <li>
                                            <label>
                                                ...
                                                <a id="iconType18" href="/tokai/feature_traffic.htm">交通費支給</a>
                                                (34238)
                                            </label>
                                        </li>
                                        <li>
                                            <label>
                                                ...
                                                <a id="iconType30" href="/tokai/feature_free_style.htm">服装自由</a>
                                                (9025)
                                            </label>
                                        </li>
                                        <li>
                                            <label>
                                                ...
                                                <a id="iconType19" href="/tokai/feature_uniform.htm">制服あり</a>
                                                (31028)
                                            </label>
                                        </li>
                                        <li>
                                            <label>
                                                ...
                                                <a id="iconType31" href="/tokai/feature_meet.htm">食事付き</a>
                                                (4828)
                                            </label>
                                        </li>
                                        <li>
                                            <label>
                                                ...
                                                <a id="iconType20" href="/tokai/feature_close_man.htm">人と接する</a>
                                                (40578)
                                            </label>
                                        </li>
                                        <li>
                                            <label>
                                                ...
                                                <a id="iconType32" href="/tokai/feature_active.htm">体を動かす</a>
                                                (10839)
                                            </label>
                                        </li>
                                        <li>
                                            <label>
                                                ...
                                                <a id="iconType21" href="/tokai/feature_skill.htm">スキルが身に付く</a>
                                                (35316)
                                            </label>
                                        </li>
                                        <li>
                                            <label>
                                                ...
                                                <a id="iconType33" href="/tokai/feature_bike.htm">バイク通勤OK</a>
                                                (3826)
                                            </label>
                                        </li>
                                        <li>
                                            <label>
                                                ...
                                                <a id="iconType22" href="/tokai/feature_car.htm">車通勤OK</a>
                                                (7598)
                                            </label>
                                        </li>
                                        <li>
                                            <label>
                                                ...
                                                <a id="iconType34" href="/tokai/feature_no_smoking.htm">職場禁煙</a>
                                                (21545)
                                            </label>
                                        </li>
                                        <li>
                                            <label>
                                                ...
                                                <a id="iconType23" href="/tokai/feature_smoking_time.htm">煙草休憩あり</a>
                                                (1521)
                                            </label>
                                        </li>
                                        <li>
                                            <label>
                                                ...
                                                <a id="iconType35" href="/tokai/feature_unexperienced.htm">未経験可</a>
                                                (48162)
                                            </label>
                                        </li>
                                        <li>
                                            <label>
                                                ...
                                                <a id="iconType24" href="/tokai/feature_permanent.htm">正社員登用あり</a>
                                                (24398)
                                            </label>
                                        </li>
                                        <li>
                                            <label>
                                                ...
                                                <a id="iconType36" href="/tokai/feature_temporary.htm">契約社員登用あり</a>
                                                (15373)
                                            </label>
                                        </li>
                                    </ul>
                        ...
                        <div id="timeMapBox" class="clearfix" style="display: block;">
                            <div class="ttl">
                                <h4>通勤時間から探す</h4>
                                <p class="allLink">
                                <a class="forceTop" href="/">全国のアルバイトへ</a>
                        ...
                        <div id="mapMapBox" class="clearfix" style="display: none;">
                            ...
                            <div class="aMap">
                                <ul>
                                    <li class="am21">
                                        <a href="/guide_area21_map.htm">愛知</a>
                                    </li>
                                    <li class="am22">
                                        <a href="/guide_area22_map.htm">岐阜</a>
                                    </li>
                                    <li class="am23">
                                        <a href="/guide_area23_map.htm">静岡</a>
                                    </li>
                                    <li class="am24">
                                        <a href="/guide_area24_map.htm">三重</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div id="pickupBox">
                    ...
                    <div class="pickup01">
                        <h3>特徴から探す</h3>
                        <p class="more"><a href="/guide_tokai_feature/">もっと見る</a></p>
                        <!-- Phan list nay viet code vao de in ra nha, t viet vi du vai cai thoi, cu viet code giong vi du la no tu in ra dung -->
                        <div class="pickuplist">
                            <ul>
                                <li>
                                    <a href="/tokai/feature_short_work.htm">短期バイト</a>
                                    (1964)
                                </li>
                                <li>
                                    <a href="/tokai/feature_day_saraly.htm">日払いOK</a>
                                    (1836)
                                </li>
                                <li>
                                    <a href="/tokai/feature_week_saraly.htm">週払いOK</a>
                                    (5753)
                                </li>
                                <li>
                                    <a href="/tokai/feature_school.htm">高校生OK</a>
                                    (3404)
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="pickup02">
                        <h3>人気職種から探す</h3>
                        <p class="more">
                        <a href="/guide_tokai_job/">もっと見る</a>
                        </p>
                        <div class="pickuplist">
                            <u>
                            </u>
                    ...
                    <div class="pickup03">
                        <h3>人気エリアから探す</h3>
                        <p class="more">
                        <a href="/guide_tokai_area/">もっと見る</a>
                        </p>
                        <div class="pickuplist">
                            <u>
                            </u>
                    ...
                    <div class="pickup04">
                        <h3>ビル名・場所から探す</h3>
                        <p class="more">
                        <a href="/guide_tokai_landmark/">もっと見る</a>
                        </p>
                        <div class="pickuplist">
                            <u>
                            </u>
                    ...
                    <div class="pickup05">
                        ...
                        <p class="more">
                        <a href="/guide_tokai_bland/">もっと見る</a>
                        </p>
                        <div class="pickuplist">
                            <u>
                            </u>
                ...
                <div id="footerArea">
                    <div class="inner">
                        ...
                        <ul class="blueLine">
                            ...
                            <li>
                                <a href="file:///C:/wamp/www/J-sen/j-sen.jp/tokai/station_1276.htm">渋谷</a>
                            </li>
                            <li>
                                <a href="file:///C:/wamp/www/J-sen/j-sen.jp/tokai/station_1279.htm">新宿</a>
                            </li>
                            <li>
                                <a href="file:///C:/wamp/www/J-sen/j-sen.jp/tokai/station_1283.htm">池袋</a>
                            </li>
                            <li>
                                <a href="file:///C:/wamp/www/J-sen/j-sen.jp/tokai/station_1513.htm">横浜</a>
                            </li>
                            <li>
