                        ...
                        <ul>
                            <!--<?php if(isset($job) && !empty($job)){?> -->
                                ...
                                <li>
                                    ...
                                    <a href="<?php echo base_url();?>guide_job/list_work/<?php echo $value['system_work_name'];?>/<?php if(isset($prefecture_id)){echo $prefecture_id;} else echo 1;?>"><?php echo $value['system_work_name'];?></a>
                                    </a>
    								<?php $value['sl'] = $value['sl']==NULL?0:$value['sl']; echo '('.$value['sl'].')';?>
                                    </p>
                                </li>
                                <?php }?>                            
                            <?php }?>                                
