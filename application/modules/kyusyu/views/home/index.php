                ...
                <div id="pickupBox">
                    ...
                    <div class="pickup02">
                        ...
                        <div class="pickuplist">
                            ...
                            ?>
                                <?php foreach ($gwork as $key => $value) { ?>
                                <li>
                                    <a href="kyusyu/special/<?php echo $value['name'];?>"><?php echo $value['name'];?></a>
                    ...
                    <div class="pickup03">
                        ...
                        <div class="pickuplist">
                            ...
                            <?php foreach ($ninki_area as $key => $value) { ?>
                                <li>
                                    <a href="kyusyu/station/<?php echo $value['id'];?>"><?php echo $value['name'];?></a>
                    ...
                    <div class="pickup04">
                        ...
                        <ul>
                            ...
                            ?>
                            <li>
                                <a href="<?php echo base_url();?>kyusyu/feature/<?php echo $shop_name[0]['feature_name'];?>"><?php echo $shop_name[0]['feature_name']?></a>
                                (<?php echo $count_work_shop[$shop_name[0]['feature_name']];?>)                             
                            </li>
                            <li>
                                <a href="<?php echo base_url();?>kyusyu/feature/<?php echo $shop_name[6]['feature_name'];?>"><?php echo $shop_name[6]['feature_name']?></a>
                                (<?php echo $count_work_shop[$shop_name[6]['feature_name']];?>)                             
                            </li>
                            <li>
                                <a href="<?php echo base_url();?>kyusyu/feature/<?php echo $feature_name[9]['feature_name'];?>"><?php echo $feature_name[9]['feature_name']?></a>
